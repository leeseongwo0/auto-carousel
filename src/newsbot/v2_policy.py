...
_EXCLUSION_PATTERNS = {
    ...
    "opinion_rumor": r"\b(opinion|i think|probably|might|could|rumou?r|unconfirmed|anonymous source|according to commenters|reaction|hype|analysts?|brokerage|research note|investment thesis|outlook|supercycle|bernstein)\b|의견|전망|루머|미확인|익명|커뮤니티 반응|소감|밈|하이프|쫓아야|무시해야|애널리스트|증권사|리서치(?:\s*보고서)?|분석가|슈퍼사이클|예상(?:한다|했다)?|본다(?:면)?|판단(?:한다|했다)?",
